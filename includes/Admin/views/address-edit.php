<div class="wrap">
    ...
    <div class="notice notice-success">
        <p><?php _e( 'Address has been updated successfully!', 'hossenmaruf' ); ?></p>
    </div>
    <?php } ?>
    ...
    <form action="" method="post">
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    <th scope="row">
                        <label for="address"><?php _e( 'Address', 'hossenmaruf' ); ?></label>
                    </th>
                    <td>
                ...
                <tr class="row<?php echo $this->has_error( 'phone' ) ? ' form-invalid' : '' ;?>">
                    <th scope="row">
                        <label for="phone"><?php _e( 'Phone', 'hossenmaruf' ); ?></label>
                    </th>
                    <td>
